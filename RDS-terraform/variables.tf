...
variable "container_name" {
  type        = list(string)
  description = "Names of containers to be configured in the infrastructure."
}

variable "mutability" {
  type        = string
  description = "Mutability behavior of container image tags in the registry."
}

variable "scan_on_push" {
  type        = bool
  description = "Enable automatic image scanning on push to the repository."
}
